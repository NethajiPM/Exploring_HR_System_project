...
public class ExploringHRSystemproject {
    ...
    public static class Main {
        public static void main(String[] args) {
            ...
            SalesRep rep1 = projectInstance.new SalesRep("Nethaji", "Pavan", 1234, 30, 180, 10, 50000, 5, 200000);
            SalesManager manager = projectInstance.new SalesManager("Mukkanti", "Surya", 5678, 35, 200, 5, 70000, 10);

            // Add SalesRep to the team
            manager.addToTeam(rep1);

            // Display information for SalesRep (Nethaji)
            System.out.println("Nethaji time to retirement: " + rep1.timeToRetirement());
            System.out.println("Nethaji's vacation time left: " + rep1.vacationTimeLeft());
            System.out.println("Nethaji's bonus: " + rep1.calculateBonus());
            System.out.println("Nethaji's commission: " + rep1.calculateCommission());

            // Display information for SalesManager (Mukkanti)
            System.out.println("Mukkanti's time to retirement: " + manager.timeToRetirement());
            System.out.println("Mukkanti's vacation time left: " + manager.vacationTimeLeft());
            System.out.println("Mukkanti's bonus: " + manager.calculateBonus());
